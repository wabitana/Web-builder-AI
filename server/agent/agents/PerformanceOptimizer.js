...
class PerformanceOptimizer extends AgentBase {
  constructor(apiKey) {
    super(apiKey, 'PerformanceOptimizer', 'Recommends and implements performance improvements.');
  }
  ...
  async execute(state) {
    ...
    try {
      ...
      // Merge into state
      state['performanceoptimizer'] = parsed;
    } catch (e) {
