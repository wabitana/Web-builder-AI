...
class ComponentSplitter extends AgentBase {
  constructor(apiKey) {
    super(apiKey, 'ComponentSplitter', 'Breaks down the wireframe into atomic, reusable React components.');
  }
  ...
  async execute(state) {
    ...
    try {
      ...
      // Merge into state
      state['componentsplitter'] = parsed;
    } catch (e) {
...
module.exports = ComponentSplitter;
