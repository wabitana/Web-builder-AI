...
class AnimationSpecialist extends AgentBase {
  constructor(apiKey) {
    super(apiKey, 'AnimationSpecialist', 'Adds Framer Motion interactions and micro-animations.');
  }
  ...
  async execute(state) {
    ...
    try {
      ...
      // Merge into state
      state['animationspecialist'] = parsed;
    } catch (e) {
...
module.exports = AnimationSpecialist;
