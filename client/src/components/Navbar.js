        ...
        <div className="flex items-center gap-3 sm:gap-4">
          {!user ? (
            <>
              ...
              <button 
                onClick={loginWithGoogle}
                className="bg-white text-black px-4 sm:px-6 py-2.5 rounded-full text-sm font-bold hover:scale-105 transition-all active:scale-95"
              >
                Get Started
              </button>
            </>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            ...
            className="md:hidden overflow-hidden border-t border-white/10 bg-black/80 backdrop-blur-lg"
          >
            <div className="flex flex-col px-6 py-4 space-y-3">
              ...
              {!user && (
                <button
                  ...
                  className="sm:hidden flex items-center gap-2 text-sm font-medium text-white py-2"
                >
                  <LogIn className="w-4 h-4" /> Log in
                </button>
              )}
